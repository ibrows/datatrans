...
class HiddenAuthorizationRequestWithAliasCCTest extends \PHPUnit_Framework_TestCase
{
     ...
     */
    public function testValidationWithAliasCC(HiddenAuthorizationRequestWithAliasCC $hiddenAuthorizationRequest, $violationCount)
    {
    ...
    public function testGetterSetterWithAliasCC()
    {
        ...
        $hiddenAuthorizationRequest->setAliasCC(TestDataInterface::ALIASCC);
        ...
        $this->assertEquals(TestDataInterface::ALIASCC, $hiddenAuthorizationRequest->getAliasCC());

...
class HiddenAuthorizationRequestWithCardNoTest extends \PHPUnit_Framework_TestCase
{
     ...
     */
    public function testValidationWithCardNo(HiddenAuthorizationRequestWithCardNo $hiddenAuthorizationRequest, $violationCount)
    {
    ...
    public function testGetterSetterWithCardNo()
    {
        ...
        $this->assertEquals(TestDataInterface::PAYMENTMETHOD, $hiddenAuthorizationRequest->getPaymentMethod());
        $this->assertEquals(TestDataInterface::CARDNUMBER, $hiddenAuthorizationRequest->getCardNo());
        $this->assertEquals(TestDataInterface::EXPM, $hiddenAuthorizationRequest->getExpm());
        $this->assertEquals(TestDataInterface::EXPY, $hiddenAuthorizationRequest->getExpy());
        $this->assertEquals(TestDataInterface::CVV, $hiddenAuthorizationRequest->getCvv());

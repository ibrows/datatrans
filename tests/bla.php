...
interface bla
{
    ...
    const RESPONSE_SUCCESS = 'https://localhost/success?
uppCustomerEmail=max.muster%40maxmustermannag.ch
testOnly=yes
amount=1000
pmethod=VIS
uppCustomerFirstName=Max
uppWebResponseMethod=GET
uppCustomerCountry=CHE
uppCustomerCity=Musterort
uppCustomerZipCode=0000
refno=91115
uppCustomerDetails=yes
hiddenMode=yes
reqtype=NOA
acqAuthorizationCode=131256
uppCustomerStreet=Musterstrasse+0
responseMessage=Authorized
avsResult=*
uppTransactionId=150109131255230325
responseCode=01
expy=15
...
expm=12
uppCustomerLastName=Mustermann
authorizationCode=256270384
status=success
uppMsgType=web';
